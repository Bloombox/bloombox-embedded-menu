...
#
# - Bloombox - bloombox-embedded-menu
#
...
all: build
	@echo "bloombox-embedded-menu is ready."
...
ifeq ($(BUILDBOT),yes)
test:
	wct --job-name "bloombox-embedded-menu" --expanded --build-number "$(BUILD_NUMBER)" --sauce-tunnel-id "$(SAUCE_TUNNEL)" --plugin wct-jenkins
else
test:
	@wct --job-name "bloombox-embedded-menu"
endif

quickbuild:
	@echo "Quickbuilding..."
	@cp -fr ./*.html ./bloombox-embedded-menu.js ./bower.json ./demo ./README.md $(TARGET)/;
